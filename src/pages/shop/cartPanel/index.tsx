import {InputNumber, Popup} from "@nutui/nutui-react-taro";
                ...
                <div style={{padding: '30px 20px', marginBottom: '100px'}}>
                    {
                        cart.map((item) => {
                            return (
                                    <div style={{display: "flex", marginBottom: '30px'}} key={item.id}>
                                        ...
                                        <div style={{
                                            ...
                                            <div style={{display: "flex", justifyContent: 'space-between',}}>
                                                ...
                                                <div>
                                                    <InputNumber modelValue={item.num} min={0} buttonSize="30"
                                                                 inputWidth="50"
                                                                 onChangeFuc={(value) => {
                                                                     dispatch(changeNum({
                                                                         id: item.id,
